...
class RefundRequestForm(ModelForm):
    class Meta:
        ...
        labels = {'date': 'Date', 'nature': 'Nature', 'expenseReport': 'Note de frais', 'mission': 'Mission', 'amountHT': 'Remboursement hors taxe', 'amountTVA': 'Remboursement avec taxes', 'proof': 'Justificatif', }
    ...
    def __init__(self, *args, **kwargs, ):
        ...
        if request is not None and request.method == 'GET':
            expRepL = ExpenseReport.objects.filter(collaborator=collab).order_by('-year')  # we look for the expense report of the user, order them by descending year
...
class AdvanceForm(ModelForm):
    class Meta:
        ...
        labels = {'date': 'Date', 'nature': 'Nature', 'expenseReport': 'Note de frais', 'mission': 'Mission', 'estimatedPrice': 'Prix estime de la demande', 'advanceCommentary': "Commentaire", }
        widgets = {'date': forms.SelectDateWidget}
...
class MileageExpenseForm(ModelForm):
    class Meta:
        ...
        fields = ['date', 'expenseReport', 'mission', 'carFiscalPower', 'startCity', 'endCity', 'distance', 'proof']
        labels = {'date': 'Date', 'nature': 'Nature', 'expenseReport': 'Note de frais', 'mission': 'Mission', 'carFiscalPower': 'Puissance fiscale du vehicule', 'startCity': 'Ville de depart', 'endCity': "Ville d'arrivee", 'distance': 'Distance', 'proof': 'Justificatif', }
        widgets = {'date': forms.SelectDateWidget}
...
class MissionForm(ModelForm):
    class Meta:
        ...
        labels = {'name': 'Nom', 'startDate': 'Date de départ', 'endDate': 'Date de fin', 'service': 'Service', }
